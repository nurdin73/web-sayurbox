  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
                ...
                {data.map((v,k)=>(
                  <tr key={v.id}>
                    ...
                    <td>
                      ...
                      <Button className="mr-1" color="success" size="sm"
                      onClick={()=>this.setState({isModalDetailProductOpen: !this.state.isModalDetailProductOpen})}
                       ><i className="fa fa-info"></i> Detail</Button>
                    </td>
                  </tr>
                ))}
              </tbody>
        ...
        />
        <DetailProduct 
        isOpen={this.state.isModalDetailProductOpen}
        modalToggle={()=>this.setState({isModalDetailProductOpen: !this.state.isModalDetailProductOpen})}
        cancelAction={()=>this.setState({isModalDetailProductOpen: !this.state.isModalDetailProductOpen})}
        />  
      </div>
    );
  }
...
class AddProductModal extends React.PureComponent{
  render(){
    ...
    <Modal toggle={this.props.modalToggle} isOpen={this.props.isOpen}>
      <ModalHeader toggle={this.props.modalToggle}>Tambah Katalog Produk</ModalHeader>
      <ModalBody>
        <FormGroup>
...
class DetailProduct extends React.PureComponent{
  render(){
    return(
      <Modal size="md" toggle={this.props.modalToggle} isOpen={this.props.isOpen}>
      <ModalHeader toggle={this.props.modalToggle}>Detail Product</ModalHeader>
      <ModalBody>
        <Row>
          <Col lg="3">
            <img alt="img product" src="https://cdn-radar.jawapos.com/uploads/radarsurabaya/news/2020/02/07/jahe-merah-bantu-hadapi-virus-corona_m_1581045456_178272.jpg"
             style={{width:"100px",height:"100px",borderRadius:5}} />
             <h6 className="mt-2">Stock: 100Kg</h6>
          </Col>
          <Col>
          <div style={{display:"flex",flexDirection:"row",justifyContent:"space-between"}}>
          <p style={{textAlign:"left",fontWeight:"bold"}}>Jahe Merah</p>
          <p className="mr-3" style={{textAlign:"left",fontWeight:"bold"}}>Rp. 10.000/Kg</p>
          </div>          
            <p>
            <b>Deskripsi: </b> <br />
            Jahe Merah Segar Jahe Merah Segar Jahe Merah Segar Jahe Merah Segar
            Jahe Merah Segar
            </p>
          </Col>
        </Row>
